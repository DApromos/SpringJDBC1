...
import org.example.springcourse.dao.PersonalDAO;
...
public class PeopleController {
    ...
    @Autowired
    public PeopleController(PersonalDAO personalDAO) {
    ...
    public String show(@PathVariable("id") int id, Model model) {
        model.addAttribute("person", personalDAO.show(id));
        return "people/show";
    }
